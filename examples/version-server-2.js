...
// Second dummy server with different versions
// Endpoints:
//   /conso/version -> 2.0.0
//   /int/version   -> 2.1.0
//   /pre/version   -> 2.2.0
//   /pro/version   -> 2.3.0
// Override via env vars: CONSO_VERSION, INT_VERSION, PRE_VERSION, PRO_VERSION

const versions = {
  conso: process.env.CONSO_VERSION || '2.0.0',
  int: process.env.INT_VERSION || '2.1.0',
  pre: process.env.PRE_VERSION || '2.2.0',
  pro: process.env.PRO_VERSION || '2.3.0',
};
...
server.listen(port, () => {
  console.log(`Version dummy server #2 listening on ${port}`);
